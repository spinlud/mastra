...
description: "Deploy Mastra applications from pnpm, npm, Yarn, or Bun monorepos by configuring workspace packages, build commands, dependencies, and environment variables."
packages:
  - "@mastra/deployer"
---
