...
description: "Build custom Mastra scorers with createScorer using JavaScript functions or LLM prompts across preprocess, analyze, generateScore, and generateReason steps."
packages:
  - "@mastra/core"
---
