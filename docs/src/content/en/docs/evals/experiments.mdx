...
You can also delete experiments with the [Core API](/reference/datasets/deleteExperiment) or [Client SDK](/reference/client-js/datasets#deleteexperiment). The same operation is available through the [server routes](/reference/server/routes#delete-an-experiment).
