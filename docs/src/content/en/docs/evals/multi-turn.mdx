...
description: "Evaluate Mastra agents across multi-turn conversations by sending sequential inputs on one memory thread and scoring individual turns or the full exchange."
packages:
  - "@mastra/core"
---
