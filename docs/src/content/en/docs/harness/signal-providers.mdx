...
description: "Build Mastra signal providers that monitor external systems through polling or webhooks and deliver notifications into long-running agent threads."
packages:
  - "@mastra/core"
---
