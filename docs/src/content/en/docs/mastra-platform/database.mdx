...
description: "Provision and attach managed Turso or Postgres databases to Mastra platform environments, then use injected credentials from your application code."
---
