---
title: "Studio"
description: "Use Mastra Studio to build, test, and manage agents, workflows, processors, tools, and MCP servers while inspecting traces and runtime behavior."
packages:
  - "@mastra/core"
---
...
Studio lets you edit your [agents](/docs/agents/overview), [workflows](/docs/workflows/overview), and other parts of your Mastra application in real time.
