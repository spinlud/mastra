---
title: 'Subagents'
description: 'Build Mastra supervisor agents that delegate work to specialized subagents with hooks, request context, message filtering, and completion scoring.'
packages:
  - '@mastra/core'
  - '@mastra/memory'
---
