...
description: "Connect Mastra agents to AI SDK UI with @mastra/ai-sdk, then build streaming chat, completion, memory, tool output, and workflow interfaces."
packages:
  - '@mastra/ai-sdk'
---
...
```typescript title="app/page.tsx" oxfmt:false
...
<Tabs>
  ...
  <TabItem value="frontend" label="Frontend">
    ...
    ```typescript title="src/components/chat.tsx" {24-35} oxfmt:false
    import { useChat } from '@ai-sdk/react'
    import { DefaultChatTransport } from 'ai'
...
<Tabs>
  ...
  <TabItem value="frontend" label="Frontend">
    ...
    ```typescript title="src/components/workflow-chat.tsx" {3,5,6,48-50} oxfmt:false
    import { useChat } from '@ai-sdk/react'
    import { DefaultChatTransport } from 'ai'
...
<Tabs>
  ...
  <TabItem value="frontend" label="Frontend">
    ...
    ```typescript title="src/components/network-chat.tsx" {3,5,42-44} oxfmt:false
    import { useChat } from '@ai-sdk/react'
    import { DefaultChatTransport } from 'ai'
...
<Tabs>
  ...
  <TabItem value="frontend" label="Frontend">
    ...
    ```typescript title="src/components/task-chat.tsx" {31-41,45} oxfmt:false
    import { useChat } from '@ai-sdk/react'
    import { DefaultChatTransport } from 'ai'
...
<Tabs>
  ...
  <TabItem value="frontend" label="Frontend">
    ...
    ```typescript title="src/components/approval-workflow.tsx" oxfmt:false
    import { useChat } from '@ai-sdk/react'
    import { DefaultChatTransport } from 'ai'
...
<Tabs>
  ...
  <TabItem value="frontend" label="Frontend">
    ...
    ```typescript title="src/components/nested-agent-chat.tsx" oxfmt:false
    import { useChat } from '@ai-sdk/react'
    import { DefaultChatTransport } from 'ai'
    import { useState } from 'react'
...
<Tabs>
  ...
  <TabItem value="frontend" label="Frontend">
    ...
    ```typescript title="src/components/weather-workflow.tsx" oxfmt:false
    import { useChat } from '@ai-sdk/react'
    import { DefaultChatTransport } from 'ai'
    import { useState } from 'react'
    import type { WorkflowDataPart } from '@mastra/ai-sdk'
