...
description: "Use ClickHouse as a Mastra analytical storage backend for observability, scores, and metrics with vNext or legacy storage domain configuration."
packages:
  - "@mastra/clickhouse"
  - "@mastra/core"
---
