...
<PropertiesTable
  ...
  {
    name: 'memory',
    type: 'false | ((args) => { thread, resource, options? } | false)',
    description:
    ...
    properties: [
      {
        ...
        parameters: [
          ...
          {
            name: 'turnDetection',
            type: '(context: VoiceCallContext) => TurnDetectionMode | undefined',
            description:
...
<PropertiesTable
  ...
  {
    name: 'memory',
    type: '{ thread: string; resource?: string; options?: MemoryConfig } | false',
    description:
