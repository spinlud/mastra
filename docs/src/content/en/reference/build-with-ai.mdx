---
title: "Build with AI"
description: "Give AI coding agents access to Mastra documentation through MCP or direct web content, with downloadable reference files available for local use."
packages:
...
1. Select **mastra**, then select **Enable**.
