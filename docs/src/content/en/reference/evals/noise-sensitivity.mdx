...
description: "The createNoiseSensitivityScorerLLM() function creates a CI/testing scorer that evaluates how reliable an agent is when exposed to irrelevant, distracting, or misleading information."
packages:
  - "@mastra/evals"
---
