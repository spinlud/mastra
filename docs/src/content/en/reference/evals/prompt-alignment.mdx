...
description: "Use createPromptAlignmentScorerLLM() to evaluate whether an agent response follows the user's intent, requirements, completeness, and requested format."
packages:
  - "@mastra/evals"
---
