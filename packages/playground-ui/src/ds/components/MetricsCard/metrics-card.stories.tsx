  ...
  render: () => (
    <div style={{ width: '30rem' }}>
      <MetricsCard>
        ...
        <MetricsCard.Content>
          <p className="text-neutral2 text-ui-md">Chart or table content goes here</p>
        </MetricsCard.Content>
      </MetricsCard>
    </div>
  ),
  ...
  render: () => (
    <div style={{ width: '30rem' }}>
      <MetricsCard>
        ...
        <MetricsCard.Content>
          <p className="text-neutral2 text-ui-md">Bar chart content goes here</p>
        </MetricsCard.Content>
      </MetricsCard>
    </div>
  ),
  ...
  render: () => (
    <div style={{ width: '30rem' }}>
      <MetricsCard>
        ...
        <MetricsCard.Content>
          <p className="text-neutral2 text-ui-md">Content area</p>
        </MetricsCard.Content>
      </MetricsCard>
    </div>
  ),
