...
const settingsRowLabelVariants = cva('', {
  variants: {
    variant: { default: 'text-ui-md font-medium', factory: 'text-ui-md leading-ui-md text-neutral5' },
  },
  defaultVariants: { variant: 'default' },
});
...
const settingsRowDescriptionVariants = cva('flex flex-col gap-0.5', {
  variants: {
    variant: { default: 'text-ui-md text-neutral3', factory: 'text-ui-sm text-neutral3' },
  },
  defaultVariants: { variant: 'default' },
});
